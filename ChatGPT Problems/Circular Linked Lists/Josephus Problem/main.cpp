    ...
    /*
        Reasons why to use the constructor
            - Initialization clarity/safety
                ...
                - Ensures Node and Data are set to meaningful values
                - This is done to ensure
                    - Data doesn't contain garbage values
                    - Next doesn't point to some random memory location
            - Consistency
                - Using constructor ensures every Node object is created in a consistent state
                - If not, program is prone to
                    - Segmentation faults
                    - Incorrect error handling
            - Encapsulation
                - Good practice to hide details about how Node is initialized
                - Makes the class easier to use correctly
    */
};
